...
data_ip="https://raw.githubusercontent.com/anggrevps/permission/main/seler"
checking_sc() {
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/anggrevps/permission/main/"
...
REPO="https://github.com/anggrevps/permission.git"
...
URL="https://api.telegram.org/bot$KEY/sendMessage"
    ...
    git remote add origin https://github.com/anggrevps/permission
    git push -f https://${TOKEN}@github.com/anggrevps/permission.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
